...
class UNet(nn.Module):
    def __init__(self, in_channels=1, n_classes=1, depth=4, wf=6, padding=True,
                 batch_norm=True, up_mode='upsample', is_leaky=False, finalact="sigmoid"):
        """
        Implementation of
...
class UNetUpBlock(nn.Module):
    def __init__(self, in_size, out_size, up_mode, padding, batch_norm, is_leaky):
        ...
        self.conv_block = UNetConvBlock(in_size, out_size, padding, batch_norm, is_leaky)
